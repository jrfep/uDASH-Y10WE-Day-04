...
```{r}
# YOUR CODE HERE
ggplot(mpg, aes(x = cty, y = hwy)) + geom_point(col = "red")
```
...
ggplot(mpg, aes(x = cty, y = hwy, col = factor(cyl))) + geom_point()
...
```{r}
# YOUR CODE HERE
ggplot(mpg, aes(x = cyl, y = displ)) + geom_boxplot()

ggplot(mpg, aes(x = cyl, y = displ, group = cyl)) + geom_boxplot()

ggplot(mpg, aes(x = factor(cyl), y = displ)) + geom_boxplot()
...
```{r}
#YOUR CODE HERE
ggplot(mpg, aes(x = factor(cyl), y = displ)) + geom_boxplot() + geom_point()
...
# YOUR CODE HERE
ggplot(mpg, aes(x = factor(cyl), y = displ)) + geom_boxplot() + geom_point(position = "jitter")

ggplot(mpg, aes(x = factor(cyl), y = displ)) + geom_boxplot() + geom_jitter(width = 0.2)
```

2. Create a histogram of the distribution of highway mileage values in mpg. Colour fill the bars by the drive type. Experiment with the position argument in the histogram geometry. What happens?

```{r}

# YOUR CODE HERE
ggplot(mpg, aes(x = hwy, fill = drv)) + geom_histogram(position = "dodge") 
ggplot(mpg, aes(x = hwy, fill = drv)) + geom_histogram(position = "fill")
ggplot(mpg, aes(x = hwy, fill = drv)) + geom_histogram(position = "stack")
